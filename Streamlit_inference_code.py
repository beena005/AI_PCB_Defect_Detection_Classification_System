...
model_path = r"C:\Users\adith\Downloads\best_resnet50_pcb_defects_50epochs_patches.pth"
...
# CONFIG
# ===================================================================
golden_images_dir = r"D:\Beena\beena\PCB Used" 
WINDOW_SIZE = 96
...
def detect_anomalies_by_comparison(input_image, golden_image, classifier):
    ...
    keep_indices = nms(boxes, scores, iou_threshold=0.03)
